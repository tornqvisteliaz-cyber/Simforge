...
const CommunitySection = () => {
  ...
  return (
    <section
      id="community"
      ref={ref}
      className="section-container bg-card/50 relative overflow-hidden"
    >
      ...
      <div className="max-w-4xl mx-auto w-full text-center relative z-10">
        ...
        >
          ...
          <p className="section-subtitle mx-auto text-center mb-12">
            Connect with fellow aviation enthusiasts, get development updates, 
            and be part of the Flight Forge journey.
          </p>
        </motion.div>
        ...
        >
          <a
            ...
            className="inline-flex items-center gap-3 btn-primary text-lg px-8 py-4 animate-pulse-glow"
          >
            <svg
              className="w-6 h-6"
              fill="currentColor"
